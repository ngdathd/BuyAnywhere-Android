...
public class DiffUtilCallBack extends DiffUtil.Callback {
    ...
    public void setItems(List<RecyclerViewAdapter.ModelWrapper> oldItems, List<RecyclerViewAdapter.ModelWrapper> newItems) {
    ...
    public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
        return oldItems.get(oldItemPosition).model.equals(newItems.get(newItemPosition).model);
    }
}
