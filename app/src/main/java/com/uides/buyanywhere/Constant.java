...
/**
 * Created by TranThanhTung on 16/09/2017.
 */
...
public class Constant {
    ...
    public static final String KEY_CLOUD_TOKEN = "cloudToken";
    ...
    public static final String DAY_MONTH_YEAR = "dd/MM/yyy";

    public static final String KEY_PASSWORD = "password";
    public static final String KEY_AUTO_SIGN_IN = "auto";
